module WeatherHelper
  ...
  def weather_list(value)
    ...
    answer = "погода: #{value['weather'][0]['description']}
    ----------
    температура: #{value['main']['temp']}, град С
    температурный градиет: #{value['main']['temp_min']} ... #{value['main']['temp_max']}, град С
    давление: #{value['main']['pressure']/10} кПа или #{value['main']['pressure']*0.75} мм рт.ст.
    влажность: #{value['main']['humidity']} %
    дальность прямой видимости: #{value['visibility']/1000} км
